...
plugin_identifier = "bedcheckai"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_bedcheckai"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "Bed Check AI"
...
# module
plugin_description = """Plugin that uses a ML model to segment the print bed and items on it."""
...
plugin_url = "https://github.com/printpal-io/OctoPrint-BedCheckAI"
